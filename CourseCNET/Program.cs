    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             * Automatic tensor - сопротивление поворота, автоматически - самое комфортное
             ...
             * также галочка CONVEX автоматически дорисовывает и корректирует полигоны и иногда -
             * упрощает обьект, облегчая его
             ...
             * Dynamic friction - если обьект не статичный
             * Static friction - если обьект статичный и что-то движется относительно его
             * Bounciness - прыгучесть + она складывается с прыгучестью обьекта, от которого отскакиваем
             * Friction combine - 
             * Bounciness combine - как будет складываться прыгучесть с обьектом от которого отскакиваем
